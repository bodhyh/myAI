  ...
  return (
    <div className="w-full flex justify-center p-10">
      <div className="w-full max-w-screen-md space-y-6">
        ...
        <h1 className="text-3xl font-bold">House MBA AI Chatbot</h1>
        ...
        <ol className="list-decimal list-inside space-y-4">
          <li className="text-gray-700">
            ...
            accessing and using the House MBA AI chatbot ("Chatbot") provided by Bogdan
          ...
          <li className="text-gray-700">
            ...
            or implied. Provider makes no representations or warranties regarding
          ...
          <li className="text-gray-700">
            ...
            Provider does not guarantee that the Chatbot will be available at all
          ...
          <li className="text-gray-700">
            ...
            the fullest extent permitted by applicable law, Provider shall not be
          ...
          <li className="text-gray-700">
            ...
            decisions made based on its output. Provider is not responsible for any
          ...
          <li className="text-gray-700">
            ...
            considered equivalent to public postings, and Provider does not
          ...
          <li className="text-gray-700">
            ...
            indemnify, defend, and hold harmless Provider from any claims,
            liabilities, damages, losses, and expenses, including reasonable
            legal fees, arising from your use of the Chatbot or violation of
            these Terms of Use.
          </li>
          <li className="text-gray-700">
            <span className="font-semibold">Modifications to Terms:</span> Provider
          ...
          <li className="text-gray-700">
            ...
            contact Provider at bogdan_maksikov@kenan-flagler.unc.edu.
          </li>
        </ol>
      </div>
    </div>
